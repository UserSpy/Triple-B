...
<html lang="en" dir="ltr">
  ...
  <div id="signupID" class="form-style" style="width:1000px; margin:0 auto;">
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <input type="text" name="isbn" placeholder="Enter 13-Digit ISBN" required
        value="<?= isset($_POST['isbn']) ? $_POST['isbn'] : ''; ?>"><br>
        <label for="price">Price</label><br>
        <input type="text" name="price" placeholder="Enter Price of the Textbook" required
        value="<?= isset($_POST['price']) ? $_POST['price'] : ''; ?>"><br><br>
        <label for="condition">Select the Condition of Your Textbook</label><br><br>
        <div class="radio-class" style="padding-left: 20px">
          <input class="radio" type="radio" id="verypoor" name="condition" value="VeryPoor" required>
          <label style="padding-right: 50px" for="verypoor">  Very Poor</label>
          <input class="radio" type="radio" id="poor" name="condition" value="Poor" required>
          <label style="padding-right: 50px" for="poor">Poor</label>
          <input class="radio" type="radio" id="fair" name="condition" value="Fair" required>
          <label style="padding-right: 50px" for="fair">Fair</label>
          <input class="radio" type="radio" id="good" name="condition" value="Good" required>
          <label style="padding-right: 50px" for="good">Good</label>
          <input class="radio" type="radio" id="excellent" name="condition" value="Excellent" required>
        ...
        Enter a Description of the textbook you are selling.
        </textarea>
        <br><br>
        <label for="state">Upload Images of Your Textbook</label><br>

        <input multiple type="file" id="images" name="images">
        <div id="preview"></div>
        <!-- code attributed to Roko C. Bulhjan https://stackoverflow.com/a/39440179 CC BY-SA 4.0  -->
